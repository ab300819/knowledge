...
- [8.3 磁盘分区、格式化、检验与挂载](#83-磁盘分区格式化检验与挂载)
    - [8.3.1 查看硬盘分区状态](#831-查看硬盘分区状态)
...
```
[root@study ~]# mkfs.xfs [-b bsize] [-d parms] [-i parms] [-l parms] [-L label] [-f]  [-r parms] 裝置名稱
選項與參數：
