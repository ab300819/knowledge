...
const DOMAIN_NAME = 'ab300819.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    themeConfig: {
        ...
        repo: 'https://github.com/ab300819', // 导航栏右侧生成Github链接
        ...
        bodyBgImgInterval: 3600, // body多张背景图时的切换间隔, 默认15，单位s
        ...
        author: {
            name: 'Mason', // 必需
            link: 'https://github.com/ab300819', // 可选的
        },
        ...
        social: {
            ...
            icons: [
                ...
                },
                {
                    ...
                    title: 'Email',
                    link: 'mailto:ab300819@hotmail.com',
                },
            ],
        },
        ...
        footer: {
            ...
            copyrightInfo:
                'Mason | <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank">CC BY-SA 4.0</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
        },
